"""
Some of the below code is modified from Nicholas Renotte's action recognition tutorial which can be found here:
https://www.youtube.com/watch?v=doDUihpj6ro&t=5051s&ab_channel=NicholasRenotte. Code has been marked where appropriate.
"""
